...
因此更换镜像源后，也不能正常工作，会报错，**下列方法也会报错**，因此建议不更改官方软件源。aur官方源目前可以访问，但速度很慢，yay上的一些软件是通过aur官方源进行安装的，需要访问外网，因此需要先安装V2ray服务。
...
所以直接安装谷歌拼音。[manjaro Linux，有什么较为简单的方法，可安装中文输入法? - 知乎用户0C8Unl的回答 - 知乎](https://www.zhihu.com/question/330715155/answer/1051545736)
...
~~因此需要在设置中安装新的驱动。~~ 此问题被修正，见2023.9.19日修正
